...
testset = torchvision.datasets.MNIST(
    root=path + "data/mnist", train=False, download=True, transform=transform
)
...
# model info
print(
    "Model No. of Parameters:", sum([param.nelement() for param in model.parameters()])
)
print(model)
...
elapsed = end - start
print(
    "Training took " + str(elapsed) + " secs or " + str(elapsed / 60) + " mins in total"
)
...
elapsed = end - start
print(
    "Testing took " + str(elapsed) + " secs or " + str(elapsed / 60) + " mins in total"
)
